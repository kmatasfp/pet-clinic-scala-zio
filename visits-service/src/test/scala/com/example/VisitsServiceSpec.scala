...
object VisitsServiceSpec extends DefaultRunnableSpec {
  ...
  def spec =
    suite("VisitsService")(
      ...
      }.provideCustomLayer(runningMySqlAndGrpcClient) @@ timeout(25.seconds),
  ...
  private val runningMySqlAndGrpcClient =
    (RunningMysql.live ++ (OpenPortFinder.live >>> VisitsGrpcService.live))
